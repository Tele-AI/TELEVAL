...
sys.path.append(os.path.join(ROOT_DIR, "models/src_llama_omni2"))
sys.path.append(os.path.join(ROOT_DIR, "models/src_llama_omni2/third_party/Matcha-TTS"))

from src.models.src_llama_omni2.cosyvoice.cli.frontend import CosyVoiceFrontEnd
