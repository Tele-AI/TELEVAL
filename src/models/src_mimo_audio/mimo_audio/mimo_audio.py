...
class MimoAudio:
    ...
    def spoken_dialogue_sft(self, input_speech, output_audio_path=None, system_prompt=None, prompt_speech=None, add_history=False):
        ...
        text = self.forward(input_ids, output_audio_path=output_audio_path, stopping_criteria=stopping_criteria, add_history=add_history) # greedy search
        return text
    ...
    def spoken_dialogue_sft_multiturn(self, message_list, output_audio_path=None, system_prompt=None, prompt_speech=None):
        ...
        text = self.forward(input_ids, output_audio_path=output_audio_path, stopping_criteria=stopping_criteria, add_history=False) # greedy search
    ...
    def speech2text_dialogue_sft(self, input_speech, thinking=False, add_history=False):
        ...
        text = self.forward(input_ids, stopping_criteria=stopping_criteria, add_history=add_history) # greedy search
    ...
    def speech2text_dialogue_sft_multiturn(self, message_list, thinking=False):
        ...
        text = self.forward(input_ids, stopping_criteria=stopping_criteria, add_history=False) # greedy search
