...
class KimiAPromptManager:
    def __init__(self, model_path: str, whisper_path: str, glm4_tokenizer: str, kimia_token_offset: int):
        self.audio_tokenizer = Glm4Tokenizer(glm4_tokenizer)
        ...
        # add for flexible
        whisper_path = whisper_path or os.path.join(model_path, "whisper-large-v3")
        self.whisper_model = WhisperEncoder(
            whisper_path, mel_batch_size=20
        )
